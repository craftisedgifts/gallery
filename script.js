...
productCards.forEach(card => {
    card.addEventListener('click', () => {
        const imageSrc = card.querySelector('data-link').getAttribute('data-link');
        const imageAlt = card.querySelector('data-link').getAttribute('data-link');
